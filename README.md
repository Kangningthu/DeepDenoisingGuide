...
## Overview
This repository contains the Jupyter notebooks accompanying the research project "Learn, Denoise and Discover: A Guide to Deep Denoising and its Application to Scientific Imaging."  It encompasses various Jupyter notebooks that serve as practical complements to the study. The website link of this project is https://kangningthu.github.io/AI-powered-denoising
...
[Natural_image](pretrained_models%2FNatural_images)

### Pre-trained Model for Microscopy Images
[Microscopy](pretrained_models%2FMicroscopy)
